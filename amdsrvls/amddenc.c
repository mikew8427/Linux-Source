/******************************************************************************
AMDS Base Encrtption routines for Blowfish
******************************************************************************/
#include "stdlib.h"
#include "stdio.h"
#include "blowfish.h"
...
short InitializeEnc(blf_ctx *bc, unsigned char key[], int keybytes)
{
         short          i;
         short          j;
         short          k;
...
{
        InitializeEnc(c, k, len);
}

void enc(blf_ctx *c, unsigned long *data, int blocks)
{
        unsigned long *d;
        int i;
...
void dec(blf_ctx *c, unsigned long *data, int blocks)
{
        unsigned long *d;
        int i;
